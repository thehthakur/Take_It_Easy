...
# node1
conv1 = ConvLayer(name="Conv1", c_in=256, c_out=256, kernel_shape=(3, 3), pads=(1, 1, 1, 1), strides=[2,2])
...
# node2
conv2 = ConvLayer(name="Conv2", c_in=256, c_out=256, kernel_shape=(2, 2), pads=(0, 0, 0, 0), strides=[2,2])
